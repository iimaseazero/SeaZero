      ...
      <div className="flex-1 flex flex-col xl:flex-row min-h-0 overflow-y-auto xl:overflow-hidden relative z-10">
        ...
        <motion.section
          ...
          className={`flex-1 overflow-y-auto px-4 sm:px-6 py-4 sm:py-5 space-y-4 sm:space-y-5 xl:h-full ${
            mobileTab === 'compete' ? 'block' : 'hidden xl:block'
          }`}
          style={{ minWidth: 0 }}
        >
        ...
        <motion.aside
          ...
          className={`w-full xl:w-[380px] flex-shrink-0 p-3 sm:p-4 flex flex-col bg-[var(--background)] border-t xl:border-t-0 xl:border-l border-[var(--border)] ${
